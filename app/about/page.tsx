...
const DEFAULT_ABOUT = `MyCareDesk started with a simple frustration: clinics deserve software that works the way they do, not the other way around.
  ...
  return (
    <div style={{ background: "var(--brand-background)" }}>
      ...
      <section style={{ background: `linear-gradient(180deg, ${NAVY} 0%, var(--brand-primary-dark) 100%)`, color: "#f4f5f7", padding: "56px 24px 44px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 32, margin: "0 0 12px" }}>Why MyCareDesk</h1>
      </section>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", padding: "48px 24px 40px" }}>
        ...
        <div style={{ marginTop: 40 }}>
          <h2 style={{ fontSize: 15, color: "#888", textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 16 }}>Why Clinics Choose MyCareDesk</h2>
          <div style={{ display: "grid", gap: 12, gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))" }}>
            {[
              ...
              ["One plan, no upsells", "MyCareDesk Core includes what a clinic actually needs to run — add-ons are optional, not required."],
              ...
              <div key={title} style={{ background: "var(--brand-surface-tint)", border: "1px solid var(--brand-border-tint)", borderRadius: 10, padding: "16px 18px" }}>
