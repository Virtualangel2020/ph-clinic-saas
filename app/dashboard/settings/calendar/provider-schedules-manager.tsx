...
const saveBtnStyle: React.CSSProperties = { background: "var(--brand-primary)", color: "#fff", fontWeight: 700, fontSize: 11, padding: "3px 9px", borderRadius: 5, border: "none", cursor: "pointer" };
