    ...
    <div style={{ background: "var(--card-bg)", border: "1px solid var(--card-border)", borderRadius: 12, padding: 22 }}>
      ...
      {providers.length === 0 ? (
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={add} disabled={pending} style={{ background: "var(--brand-primary)", color: "#fff", fontWeight: 700, fontSize: 12, padding: "7px 14px", borderRadius: 6, border: "none", cursor: "pointer" }}>
            {pending ? "Adding…" : "Add"}
          </button>
        </div>
      )}
...
const fieldStyle: React.CSSProperties = { border: "1px solid var(--input-border)", borderRadius: 6, padding: "6px 8px", fontSize: 12.5 };
