...
//     MyCareDesk Provider" flow (app/dashboard/encounters/*) to find a
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      <p style={{ color: "#666", fontSize: 13, marginBottom: 20 }}>
        ...
        below. Turning on "Show my profile publicly" additionally lists you on MyCareDesk's public Find a
