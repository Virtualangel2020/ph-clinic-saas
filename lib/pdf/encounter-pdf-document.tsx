...
const styles = StyleSheet.create({
  ...
  encounterHeaderBar: { backgroundColor: "#0b2d5c", color: "#049ca0", padding: "6 10", borderRadius: 3, marginBottom: 8, flexDirection: "row", justifyContent: "space-between" },
  ...
  soapLabel: { fontSize: 9, fontWeight: 700, color: "#0b2d5c", marginBottom: 1, marginTop: 6 },
