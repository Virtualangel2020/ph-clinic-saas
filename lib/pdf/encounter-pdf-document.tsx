...
const styles = StyleSheet.create({
  ...
  patientValue: { fontSize: 11, fontWeight: 700, color: "#0f5a8c", marginTop: 1 },
  encounterSection: { marginBottom: 18 },
  encounterHeaderBar: { backgroundColor: "#0f5a8c", color: "#ffffff", padding: "6 10", borderRadius: 3, marginBottom: 8, flexDirection: "row", justifyContent: "space-between" },
  ...
  soapLabel: { fontSize: 9, fontWeight: 700, color: "#0f5a8c", marginBottom: 1, marginTop: 6 },
